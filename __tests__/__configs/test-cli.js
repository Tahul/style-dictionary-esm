export default {
  ...
  platforms: {
    'web': {
      transformGroup: 'web',
      prefix: 'smop',
      buildPath: '__tests__/__output-cli/web/',
      files: [
        {
    ...
    'scss': {
      transformGroup: 'scss',
      prefix: 'smop',
      buildPath: '__tests__/__output-cli/scss/',
      files: [
        {
    ...
    'less': {
      transformGroup: 'less',
      prefix: 'smop',
      buildPath: '__tests__/__output-cli/less/',
      files: [
        {
    ...
    'android': {
      ...
      buildPath: '__tests__/__output-cli/',
      files: [
        {
    ...
    'ios': {
      transformGroup: 'ios',
      buildPath: '__tests__/__output-cli/ios/',
      files: [
        {
    ...
    'react-native': {
      ...
      buildPath: '__tests__/__output-cli/react-native/',
      files: [
        {
