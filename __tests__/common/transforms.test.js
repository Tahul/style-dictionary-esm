  ...
  describe('transforms', () => {
    ...
    describe('size/remToSp', () => {
      ...
      it('converts rem to sp using custom base font', () => {
        const value = transforms['size/remToSp'].transformer({ value: '1' }, { basePxFontSize: 14 })
    ...
    describe('size/remToDp', () => {
      ...
      it('converts rem to dp using custom base font', () => {
        const value = transforms['size/remToDp'].transformer({ value: '1' }, { basePxFontSize: 14 })
    ...
    describe('size/remToPt', () => {
      ...
      it('converts rem to pt using custom base font', () => {
        const value = transforms['size/remToPt'].transformer({ value: '1' }, { basePxFontSize: 14 })
    ...
    describe('size/compose/remToSp', () => {
      ...
      it('converts rem to sp using custom base font', () => {
        const value = transforms['size/compose/remToSp'].transformer({ value: '1' }, { basePxFontSize: 14 })
    ...
    describe('size/compose/remToDp', () => {
      ...
      it('converts rem to dp using custom base font', () => {
        const value = transforms['size/compose/remToDp'].transformer({ value: '1' }, { basePxFontSize: 14 })
    ...
    describe('size/swift/remToCGFloat', () => {
      ...
      it('converts rem to CGFloat using custom base font', () => {
        const value = transforms['size/swift/remToCGFloat'].transformer({ value: '1' }, { basePxFontSize: 14 })
    ...
    describe('size/remToPx', () => {
      ...
      it('converts rem to px using custom base font', () => {
        const value = transforms['size/remToPx'].transformer({ value: '1' }, { basePxFontSize: 14 })
    ...
    describe('size/flutter/remToDouble', () => {
      ...
      it('converts rem to double using custom base font', () => {
        const value = transforms['size/flutter/remToDouble'].transformer({ value: '1' }, { basePxFontSize: 14 })
